...
def splitdata_train_test(data, fraction_training):
  ...
  test_point_value = round(fraction_training*length)
  training = data[0:test_point_value]
  testing = data[(test_point_value):length+1]
...
def dtc_predict_actual(data):
  # split the data into training and testing sets using a training fraction
